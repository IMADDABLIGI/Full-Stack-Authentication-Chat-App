...
api.interceptors.request.use(
  // This is the argument that is responsible for intercepting our process of sending requests to check if we have an access token and add it else return an error
  (config) => {
